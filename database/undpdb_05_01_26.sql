...
INSERT INTO `mat_predia_crev_note` VALUES (5,3,4,'2025-10-05 11:28:50',7,NULL,8,NULL,4,NULL,10,NULL,3,NULL,9,'dddddddddddddd',9,'dddddddddddddddddqqqqqqqqqqqq',7,'rrrrrrrrrrrrrrrrrrrr',9,'yyyyyyyyyyyyyyyyyyy',8,'vvvvvvvvvvvvvvvvvvvvvvvvvvvvv',2,NULL,9,NULL,7,NULL),(6,1,1,'2025-10-06 10:53:03',3,'la',4,'vie',7,'est',8,'belle',7,'quand',9,'on',6,'est',9,'pas',9,'seul',3,NULL,4,'f',5,NULL,7,NULL),(8,1,3,'2025-10-08 17:07:07',7,NULL,8,NULL,8,NULL,8,NULL,0,NULL,0,NULL,0,NULL,0,NULL,0,NULL,0,NULL,0,NULL,0,NULL,0,NULL);
...
INSERT INTO `matrice_diag_integral` VALUES (1,'Situation juridique et fiscale',1,'Le gestionnaire connaît-il les exigences légales pour que l\'entreprise fonctionne ?'),(2,'Situation juridique et fiscale',2,'Les exigences légales sont-elles remplies pour que l\'entreprise fonctionne ?'),(3,'Situation juridique et fiscale',3,'L\'entreprise respecte-t-elle ses engagements fiscaux et ses obligations de reporting ?'),(4,'Situation juridique et fiscale',4,'L\'entreprise respecte-t-elle la réglementation du travail ?'),(5,'Leadership et climat organisationnel',5,'Le travail est vraiment motivant, les employés l\'apprécient.'),(6,'Leadership et climat organisationnel',6,'Les gens semblent fiers de l\'organisation.'),(7,'Leadership et climat organisationnel',7,'Les employés fournissent beaucoup d\'efforts dans ce qu\'ils font.'),(8,'Leadership et climat organisationnel',8,'Le propriétaire/leader communique régulièrement avec les subordonnés sur les projets futurs.'),(9,'Leadership et climat organisationnel',9,'Le propriétaire/leader s\'intéresse à de nouvelles et meilleures options bénéfiques pour l\'entreprise et les employés.'),(10,'Leadership et climat organisationnel',10,'Le propriétaire/leader est ouvert et communique correctement avec le personnel.'),(11,'Leadership et climat organisationnel',11,'Le(s) propriétaire(s) sait/savent déléguer et convaincre les gens du pourquoi et du comment des actions.'),(12,'Leadership et climat organisationnel',12,'Le travail est axé sur l\'atteinte des objectifs et des buts.'),(13,'Organisation de l\'entreprise',13,'L\'entreprise a une structure organisationnelle claire (organigramme) (même si elle n\'est pas documentée)'),(14,'Organisation de l\'entreprise',14,'L\'entreprise dispose d\'une procédure pour élaborer la structure organisationnelle.'),(15,'Organisation de l\'entreprise',16,'L\'entreprise a des procédures pour la sélection, le recrutement et la formation des travailleurs.'),(16,'Organisation de l\'entreprise',17,'L\'entreprise a un système de rémunération qui garantit une rétribution équitable de l\'argent et autres avantages.'),(17,'Organisation de l\'entreprise',18,'Les travailleurs, employés et managers possèdent les compétences appropriées pour leur poste.\r'),(18,'Organisation de l\'entreprise',19,'L\'entreprise dispose d\'un système de communication permettant de présenter les instructions de travail.'),(19,'Organisation de l\'entreprise',20,'Le propriétaire de l\'entreprise ou un employé responsable des ressources humaines manifeste de l\'intérêt pour les besoins du personnel.'),(20,'Finance et Comptabilité',21,'Les opérations commerciales sont-elles enregistrées pour la comptabilité ?'),(21,'Finance et Comptabilité',22,'Quel pourcentage des produits/services de l\'entreprise a été analysé en fonction de leur coût exact ?'),(22,'Finance et Comptabilité',23,'Un budget ou des projections de base ont-ils été établis pour l\'année en cours ?'),(23,'Finance et Comptabilité',24,'L\'entreprise a-t-elle le potentiel d\'accéder au crédit ?'),(24,'Finance et Comptabilité',25,'L\'entreprise accorde-t-elle des crédits à ses principaux clients ?'),(25,'Finance et Comptabilité',26,'Les fournisseurs accordent-ils du crédit à l\'entreprise et tiennent-ils de bons registres ?'),(26,'Finance et Comptabilité',27,'Les informations comptables garantissent-elles que l\'entreprise génère des bénéfices ?'),(27,'Finance et Comptabilité',28,'Si un bénéfice est réalisé, des primes sont-elles distribuées aux employés ?'),(28,'Planification Stratégique',29,'L\'entreprise dispose d\'un plan qui aide à guider les activités commerciales (même s\'il n\'est pas écrit/documenté).'),(29,'Planification Stratégique',30,'Le plan fournit des informations pour prendre des décisions opérationnelles.'),(30,'Planification Stratégique',31,'Le plan définit des indicateurs et des objectifs clairs (même s\'il n\'est pas écrit/documenté).'),(31,'Planification Stratégique',32,'Lors de l\'élaboration du plan, les éléments suivants ont été pris en compte : forces, faiblesses, opportunités et menaces. Cela constitue la base pour développer des stratégies.'),(32,'Planification Stratégique',33,'Dans quelle mesure le secteur d\'activité dans lequel l\'entreprise opère est-il analysé ?'),(33,'Planification Stratégique',34,'Les activités développées permettent-elles d\'atteindre les objectifs du plan de travail ?'),(34,'Planification Stratégique',35,'Le budget est-il créé en tenant compte du plan de travail ?'),(35,'Production et Opérations',36,'L\'activité commerciale reste active et en croissance.'),(36,'Production et Opérations',37,'Les produits et services correspondent aux besoins et attentes identifiés des clients.'),(37,'Production et Opérations',38,'La quantité de machines et d’équipements disponibles pour l’entreprise est suffisante pour répondre à la demande de produits ou de services.'),(38,'Production et Opérations',39,'Les installations sont suffisantes et appropriées pour développer les activités de l\'entreprise.'),(39,'Production et Opérations',40,'L’entreprise sait où acheter les matières premières aux meilleurs prix.'),(40,'Production et Opérations',41,'Les achats sont effectués en fonction des prévisions de ventes.'),(41,'Production et Opérations',42,'L’entreprise développe des contrôles écrits et systématiques sur les processus de production.'),(42,'Production et Opérations',43,'La capacité installée de l\'entreprise est pleinement utilisée.'),(43,'Assurance Qualité',44,'L’entreprise applique des mesures d’assurance qualité (même si elle ne dispose pas d’un protocole écrit).'),(44,'Assurance Qualité',45,'L’entreprise a formalisé (via des POS écrits) la manière dont la qualité des produits/services est mesurée.'),(45,'Assurance Qualité',46,'Lors de la production ou de la prestation d’un service, l’entreprise effectue des contrôles systématiques pour garantir le respect des procédures de qualité écrites.'),(46,'Assurance Qualité',47,'Les résultats du processus sont analysés pour détecter des changements et apporter les corrections nécessaires.'),(47,'Assurance Qualité',48,'Toutes les opérations effectuées sont enregistrées.'),(48,'Assurance Qualité',49,'L’entreprise dispose d’un système d’enregistrement et de gestion des informations relatives aux opérations, aux documents ou à d’autres informations importantes.'),(49,'Assurance Qualité',50,'À quel point l’entreprise a-t-elle établi que la qualité est l’une de ses priorités ?'),(50,'Assurance Qualité',51,'Les produits/services de l’entreprise sont conformes aux normes techniques.'),(51,'Commercialisation',52,'Les ventes ont augmenté par rapport à l’année précédente.'),(52,'Commercialisation',53,'Dans quelle mesure les segments de marché servis par l’entreprise ont-ils été identifiés?'),(53,'Commercialisation',54,'Niveau de connaissance des clients de l’entreprise, leurs goûts, leurs besoins et les raisons derrière l’achat de produits/services.'),(54,'Commercialisation',55,'L’entreprise connaît les habitudes d’achat et de paiement de ses utilisateurs et consommateurs.'),(55,'Commercialisation',56,'L’entreprise sait si ses clients sont satisfaits de son produit/service.'),(56,'Commercialisation',57,'Les prix de vente sont fixés en fonction du marché.'),(57,'Commercialisation',58,'Les responsables des ventes sont correctement formés.'),(58,'Commercialisation',59,'L’entreprise dispose d’un profil actif sur les réseaux sociaux pour promouvoir son activité.'),(59,'Commercialisation',60,'Dans quelle mesure le système de distribution de l’entreprise est-il efficace?'),(60,'Commercialisation',61,'Dans quelle mesure la concurrence est-elle connue, notamment ses faiblesses et ses forces ?'),(61,'Commercialisation',62,'L’entreprise dispose d’un plan marketing, qui est formulé, mis en œuvre et évalué.'),(62,'Difficultes',NULL,'Quelles sont les 3 principales difficultés que l\'entreprise a identifiées tout au long de son histoire et qui persistent encore '),(63,'forces',NULL,'Définissez 3 forces de l\'entreprise en tant que fournisseur d\'une entreprise'),(64,'faiblesses',NULL,'Définissez 3 faiblesses de l\'entreprise en tant que fournisseur d\'une entreprise'),(65,'besoins',NULL,'Définissez, en collaboration avec l\'entrepreneur, les 3 besoins les plus essentiels par ordre de priorité'),(66,'Organisation de l\'entreprise',15,'Les rôles et responsabilités du personnel sont écrits.');
...
CREATE TABLE `matrice_diag_integral_note` (
  ...
  `comt_62` mediumtext,
  `difficult_1` mediumtext,
  `difficult_2` mediumtext,
  `difficult_3` mediumtext,
  `force_1` mediumtext,
  `force_2` mediumtext,
  `force_3` mediumtext,
...
INSERT INTO `matrice_diag_integral_note` VALUES (7,1,1,'2025-12-18 06:11:07',3,NULL,5,'la vie est belle',0,NULL,0,NULL,0,NULL,0,NULL,0,NULL,0,NULL,0,NULL,0,NULL,0,NULL,0,NULL,0,NULL,0,NULL,0,NULL,0,NULL,0,NULL,0,NULL,0,NULL,0,NULL,0,NULL,0,NULL,0,NULL,0,NULL,0,NULL,0,NULL,0,NULL,0,NULL,0,NULL,0,NULL,0,NULL,0,NULL,0,NULL,0,NULL,0,NULL,4,NULL,6,NULL,5,NULL,8,NULL,0,NULL,0,NULL,0,NULL,0,NULL,0,NULL,0,NULL,0,NULL,0,NULL,0,NULL,0,NULL,0,NULL,0,NULL,5,NULL,7,NULL,8,'La fin',4,'ahr',0,NULL,0,NULL,0,NULL,0,NULL,0,NULL,0,NULL,0,NULL,'fffffffffff','kkkkkkkkkkkk','000000000000','ee','rr','tt','bb','nn','ww','aa','qq','ss');
...
-- Dump completed on 2026-01-05 16:35:25
