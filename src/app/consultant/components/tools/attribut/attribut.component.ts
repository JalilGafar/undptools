...
export class AttributComponent implements OnInit {
  ...
  ventesOptions = [
    ...
    { value: 'Entre 1 et 2 millions',     label: 'Entre 1 et 2 millions FCFA' },
    { value: 'Entre 2 et 3 millions',     label: 'Entre 2 et 3 millions FCFA' },
    { value: 'Entre 4 et 6.5 millions',   label: 'Entre 4 et 6,5 millions FCFA' },
    { value: 'Plus de 6.5 millions',      label: 'Plus de 6,5 millions FCFA' },
  ];
  ...
  situationOptions = [
    ...
    { value: 'Revenu secondaire',            label: "C'est une source de revenu secondaire, ce n'est pas ma priorité principale." },
    { value: 'Durée incertaine',             label: "Je ne suis pas sûr de combien de temps je vais la maintenir active." },
  ];
...
/////les données d'un consultant empruntant son ID
    ...
    this.toolService.ToolAttribData$.pipe(
      tap(data => {
        if (data.length > 0) {
          const d = data[0];
          this.matAttribForm.patchValue({
            note_1: d.note_1, comment_1: d.comment_1,
            note_2: d.note_2, comment_2: d.comment_2,
            note_3: d.note_3, comment_3: d.comment_3,
            note_4: d.note_4, comment_4: d.comment_4,
            note_5: d.note_5, comment_5: d.comment_5,
            note_6: d.note_6, comment_6: d.comment_6,
            note_7: d.note_7, comment_7: d.comment_7,
            note_8: d.note_8, comment_8: d.comment_8,
            note_9: d.note_9, comment_9: d.comment_9,
            note_10: d.note_10, comment_10: d.comment_10,
            note_11: d.note_11, comment_11: d.comment_11,
            note_12: d.note_12, comment_12: d.comment_12,
            note_13: d.note_13, comment_13: d.comment_13,
            note_14: d.note_14, comment_14: d.comment_14,
            note_15: d.note_15, comment_15: d.comment_15,
            note_16: d.note_16, comment_16: d.comment_16,
            note_17: d.note_17, comment_17: d.comment_17,
            note_18: d.note_18, comment_18: d.comment_18,
            note_19: d.note_19, comment_19: d.comment_19,
          });
  ...
  saveTool() {
    this.isSaving = true;
    const payload = { ...this.matAttribForm.value, ...this.generalForm.value };
